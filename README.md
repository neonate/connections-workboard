...
### ⚠️ Important for Corporate Environment Users
If you have `npm_config_registry` set to a corporate internal registry in your environment, this project includes `.npmrc` files that override it to use the standard npm registry. This prevents deployment issues and ensures all team members use consistent package sources.
